FROM ubuntu:14.04
MAINTAINER Luis Roberto "luis.robertop87@gmail.com"
...
# Maven related
# -------------
ENV MAVEN_ROOT /var/lib/maven ENV MAVEN_HOME $MAVEN_ROOT/apache-maven-$MAVEN_VERSION ENV MAVEN_OPTS -Xms256m -Xmx512m RUN echo "# Installing Maven " && echo ${MAVEN_VERSION} && \
...
# Node related # ------------ RUN echo "# Installing Nodejs" && \
